...
const DEFAULTS = {
  ...
  eeApprovedFirePrecision: toNumber(process.env.EE_APPROVED_FIRE_PRECISION, 0),
  eeApprovedFireRecall: toNumber(process.env.EE_APPROVED_FIRE_RECALL, 0),
...
export function getConfig() {
  return {
    ...
    eeApprovedFirePrecision: DEFAULTS.eeApprovedFirePrecision,
    eeApprovedFireRecall: DEFAULTS.eeApprovedFireRecall,
